...
# financemanagement— Club Finance Manager

financemanagement  is a lightweight, offline-first financial management system built for club treasurers. It runs entirely in the browser — no server, no database, no subscription required.
...
### Login & Roles
financemanagement  supports two users. On the login screen, select your role and enter your password:
