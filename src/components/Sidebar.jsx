  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontWeight: 700, fontSize: 15, color: '#fff', letterSpacing: '-0.3px' }}>ClubVault</div>
      ...
      {user && (
        <div style={{
          ...
          padding: '8px 12px',
          borderRadius: 8,
          background: isAdmin ? 'rgba(59,130,246,0.1)' : 'rgba(245,158,11,0.1)',
          border: `1px solid ${isAdmin ? 'rgba(59,130,246,0.2)' : 'rgba(245,158,11,0.2)'}`,
          ...
          <div>
            <div style={{ fontSize: 11, fontWeight: 700, color: isAdmin ? 'var(--primary)' : '#f59e0b', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
              {user.username}
            </div>
            <div style={{ fontSize: 9, color: 'var(--muted)', marginTop: 1 }}>
              {isAdmin ? 'Full access' : 'View & print only'}
            </div>
          </div>
        </div>
      )}
      ...
      <div style={{
        ...
        <div style={{ padding: '6px 12px 2px', fontSize: 10, color: 'var(--border)' }}>
